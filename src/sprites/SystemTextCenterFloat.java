...
public class SystemTextCenterFloat extends TextSprite {
	...
	public void draw(Graphics context) {
		...
		if (shine) {
			GradientPaint gp = new GradientPaint(getX(), getY(), new Color(ColorPack.PRIMARY.getRed(), ColorPack.PRIMARY.getGreen(), ColorPack.PRIMARY.getBlue(), opac), getX() + getWidth(),
					getY() + getHeight(), new Color(ColorPack.SECONDARY.getRed(), ColorPack.SECONDARY.getGreen(), ColorPack.SECONDARY.getBlue(), opac));
